...
const fetchMuddaGroupWiseCount = ( { filters } ) => {
    ...
    const calculateTotals = ( data ) => {
        const totals = data.reduce( ( acc, record ) => ( {
            ...
            totalEscaped: acc.totalEscaped + ( parseInt( record.totalEscaped || record.TotalEscaped || 0 ) || 0 ),
            totalReturned: acc.totalReturned + ( parseInt( record.totalReturned || record.TotalReturned || 0 ) || 0 ),
