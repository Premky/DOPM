...
const fetchBandiStatus = ( bandi_id ) => {
    ...
    useEffect( () => {
        const fetchRecords = async () => {
            try {
                const response = await axios.get( `${ BASE_URL }/public/bandi_status`, { withCredentials: true } );
...
export default fetchBandiStatus;
