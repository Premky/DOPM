...
const fetchBandiReleaseDetails = ( bandi_id ) => {
    ...
    const fetchBandiRecords = async () => {
        try {
            const response = await axios.get( `${ BASE_URL }/bandi/get_bandi_release/${bandi_id}`, { withCredentials: true } );
...
export default fetchBandiReleaseDetails;
