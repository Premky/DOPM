...
const fetchFineTypes = ( bandi_id ) => {
    ...
    useEffect( () => {
        const fetchRecords = async () => {
            try {
                const response = await axios.get( `${ BASE_URL }/public/get_fine_types`, { withCredentials: true } );
