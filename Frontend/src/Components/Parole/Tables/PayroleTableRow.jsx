...
import { addBSTime, calculateBSDate, convertDaysToBSYMD, sumDates } from "../../../../Utils/dateCalculator";
// import { calculateBSDate } from "../../../../Utils/newDateCalculator";

import { maxHeight } from "@mui/system";
import { resolveParoleStatus } from "./resolveParoleStatus";
const isValidBSDate = ( date ) => {
...
const PayroleTableRow = ( {
  ...
  const escapedDuration = React.useMemo(
      ...
      >
        ...
        <TableCell rowSpan={rowSpan}>
          ...
          {data?.total_escape_duration_days > 0 && (
            <>
              <br /><i>थुना बाहिर रहेको अवधि: <br /></i>{escapeDurationDays} दिन <br />
