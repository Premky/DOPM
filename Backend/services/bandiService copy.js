    ...
    sheet.addRow( [
      ...
      b.country_name_en === "Nepal" ?
        language === "en" ? `${ b.city_name_en }-${ b.wardno }, ${ b.district_name_en }, ${ b.state_name_en }` :
          `${ b.city_name_np }-${ b.wardno }, ${ b.district_name_np }, ${ b.state_name_np }` : b.bidesh_nagarik_address_details,
      ...
      b.spouse_name,
      b.spouse_contact,
      b.father_name + ( b.father_contact ? ` / ${ b.father_contact }` : "" ),
      b.mother_name + ( b.mother_contact ? ` / ${ b.mother_contact }` : "" ),
      b.imprison_date_bs,
      b.release_date_bs,
